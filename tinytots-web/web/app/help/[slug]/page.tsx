    ...
    <div className="w-full max-w-full overflow-x-hidden py-8 px-4 sm:px-6">
      <article className="w-full max-w-2xl mx-auto">
        <nav
          ...
          className="flex flex-wrap items-center gap-1.5 text-sm text-text-secondary mb-6"
        >
        ...
        <header className="mb-6">
          <p className="text-xs sm:text-sm text-brand-primary uppercase tracking-wider font-semibold mb-2">
            {categoryLabel}
          </p>
...
[&_a]:text-brand-primary [&_a]:underline [&_a]:break-all"
        ...
        {related && related.length > 0 && (
          <aside className="mt-10 pt-8 border-t border-border-default">
