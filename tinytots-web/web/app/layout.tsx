    ...
    <div className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm flex items-start justify-center pt-24 px-4">
      <div className="bg-surface w-full max-w-xl rounded-2xl shadow-xl p-6">
        <form onSubmit={handleSearch} className="flex gap-3 mb-4">
          ...
          <button
            type="submit"
            className="bg-primary-container text-on-primary px-5 rounded-lg font-button text-button hover:bg-primary transition-colors"
          >
            {loading ? "..." : "Go"}
          </button>
          <button
            type="button"
            onClick={onClose}
            className="text-on-surface-variant hover:text-primary px-2"
          >
            ✕
          </button>
        </form>
              ...
              <div className="flex flex-col gap-4 min-w-0">
                ...
                <div className="flex flex-col sm:flex-row rounded-lg border border-outline-variant/50 overflow-hidden sm:h-[48px]">
                  <input
                    ...
                    type="email"
                  />
                  <button className="shrink-0 bg-primary-container text-on-primary px-6 py-3 sm:py-0 font-button text-button hover:bg-primary transition-colors whitespace-nowrap">
                    Subscribe
                  </button>
                </div>
              </div>
