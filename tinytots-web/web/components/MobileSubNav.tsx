...
export default function MobileSubNav() {
  ...
  return (
    <div className="md:hidden flex items-center gap-2 px-margin-mobile py-2 border-b border-border-default bg-surface-canvas/80 backdrop-blur-md">
      <button
        onClick={() => router.back()}
        aria-label="Go back"
        className="flex items-center gap-1 text-text-secondary hover:text-brand-primary px-2 py-1 rounded-lg"
      >
