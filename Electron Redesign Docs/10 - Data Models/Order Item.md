...
Individual sellable lines contained within an order.
...
An Order Item represents one line within an Order and should preserve the transaction-time information required by the source system.
...
Exact snapshot fields, pricing fields, quantity rules, discount representation, and identifiers are TODO unless verified.
