...
| Field | Value |
|---|---|
| Document ID | 10-Offline Queue Item |
...
Persisted offline operations awaiting synchronization.
...
The exact queue schema, retry metadata, operation types, persistence mechanism, and deduplication behavior must be verified from the current implementation.
