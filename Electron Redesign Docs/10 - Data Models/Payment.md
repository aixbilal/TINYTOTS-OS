...
Payment records and their relationship to transactions.
...
Payment is a transaction-related data model, not a synonym for Order.
...
Exact payment methods, statuses, references, and provider fields must be verified rather than assumed.
