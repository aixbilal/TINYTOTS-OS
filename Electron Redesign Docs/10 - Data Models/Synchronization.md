...
| Field | Value |
|---|---|
| Document ID | 10-Synchronization |
...
Data synchronization state and synchronization-related metadata.
...
This model documents synchronization-related data rather than the synchronization feature itself. Operational behavior belongs to **09 — Features / Inventory Sync.md**.
