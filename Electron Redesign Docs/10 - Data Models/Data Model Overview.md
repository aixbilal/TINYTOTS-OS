...
| Field | Value |
|---|---|
| Document ID | 10-Data Model Overview |
...
Canonical map of the TinyTots data domain and relationships.
...
The exact relationships, cardinalities, identifiers, constraints, and foreign keys must be derived from the redesign specification and verified repository/database schema. Unsupported relationships remain TODO.
