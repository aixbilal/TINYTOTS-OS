...
| Field | Value |
|---|---|
| Document ID | 10-Role & Permission |
...
Authorization roles and permission relationships.
...
The exact role model may differ in the implementation. Do not assume a specific role-to-permission cardinality without source or repository evidence.
