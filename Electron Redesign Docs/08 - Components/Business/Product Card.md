...
| Field | Value |
|---|---|
| Document ID | 08-Business-Product Card |
| Folder | 08 - Components/Business |
| Status | Planned |
| Version | 1.0.0 |
...
Domain-specific reusable product presentation used across product browsing, POS, recommendations, and inventory contexts.
