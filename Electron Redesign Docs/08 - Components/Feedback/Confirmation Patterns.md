...
| Field | Value |
|---|---|
| Document ID | 08-Feedback-Confirmation Patterns |
| Folder | 08 - Components/Feedback |
| Status | Planned |
| Version | 1.0.0 |
...
Reusable confirmation patterns for destructive or consequential actions, including refunds, deletion, and irreversible changes.
