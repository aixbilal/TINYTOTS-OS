...
| Field | Value |
|---|---|
| Document ID | 08-Charts-Line |
| Folder | 08 - Components/Charts |
| Status | Planned |
| Version | 1.0.0 |
...
Line-chart component rules for trends, time series, labels, tooltips, accessibility, and empty/loading states.
