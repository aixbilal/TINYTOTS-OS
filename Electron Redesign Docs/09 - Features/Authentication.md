...
Identity verification, login, logout, and session-related capability.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **Authentication**.
...
It covers identity verification and session lifecycle. Global session/startup infrastructure remains defined in Phase 06 and should be referenced rather than duplicated.
