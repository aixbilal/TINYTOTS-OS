...
Operational events that produce user-facing notifications.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **Notifications**.
...
Phase 06 defines the global notification infrastructure.

Phase 09 defines the operational events and feature workflows that produce notifications.

```text
06 — Notification Infrastructure
            ↓
09 — Operational Notification Events
```
