...
Electron application update lifecycle and recovery behavior.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **Auto Updates**.
...
Only source-supported update stages should be treated as requirements. Rollback and recovery behavior remain TODO unless verified.
