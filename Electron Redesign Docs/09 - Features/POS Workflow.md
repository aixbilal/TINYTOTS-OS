...
End-to-end point-of-sale transaction lifecycle.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **POS Workflow**.
...
The POS workflow is the end-to-end transaction capability. It composes screen and component behavior with business logic and supporting capabilities.
...
Exact steps, branching rules, and validation gates must follow the redesign source and verified implementation.
