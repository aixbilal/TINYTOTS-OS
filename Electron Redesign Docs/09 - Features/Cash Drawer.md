...
Cash-drawer operations and hardware integration.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **Cash Drawer**.
