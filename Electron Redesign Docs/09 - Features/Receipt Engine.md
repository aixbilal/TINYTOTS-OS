...
Receipt construction, rendering, and receipt-data lifecycle.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **Receipt Engine**.
...
The receipt engine concerns constructing and rendering receipt output from transaction data.

It is distinct from:

- **Receipt Printing** — delivering the generated output to printer hardware.
- **Receipt Viewer** — the reusable UI component documented in Phase 08.

This separation prevents receipt generation, presentation, and hardware delivery from becoming one undocumented capability.
