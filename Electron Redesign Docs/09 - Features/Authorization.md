...
Role and permission enforcement for protected operations.

## Scope

This document defines the operational capability, workflow, business behavior, system boundaries, and implementation considerations for **Authorization**.
...
It covers roles, permissions, protected operations, restricted screens/actions, and permission failures. Authentication itself remains documented separately.
